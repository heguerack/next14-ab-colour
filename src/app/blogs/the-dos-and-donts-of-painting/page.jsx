...
import { blogsPageData, dosdonts } from '../../../../data/blogsPageData'
...
export default function BlogsPage() {
  const blog = blogsPageData[1]
  return (
    <main className='bg-[var(--gray-1)]  md:px-8  md:py-12 lg:px-16 xl:px-32 3xl:px-64  xl:py-16 2xl:py-24 container m-auto  text-justify text-lg leading-relaxed w-[100%] xl:w-[90vw] 2xl:w-[80vw]'>
      ...
      <div className='m-auto sm:rounded-b-lg  w-[100%] px-4 '>
        {dosdonts.map((item, index) => (
          <div key={index}>
            ...
            &apos; just like that, it wont read it right. */}
            <p>{item.p}</p>
          </div>
        ))}
