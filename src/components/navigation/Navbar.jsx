...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    document.addEventListener('click', handleOutsideClickOrHover)

    return () => {
      document.removeEventListener('mouseover', handleOutsideClickOrHover)
      document.removeEventListener('click', handleOutsideClickOrHover)
    }
  }, [servicesDropdownRef, aboutDropdownRef])

  const handleKeyDown = (event, toggleDropdown, dropdownState) => {
      ...
      <ul
        ...
        <li className='dropdown relative px-4' ref={aboutDropdownRef}>
          <button
            ...
            onKeyDown={(e) =>
              handleKeyDown(e, setShowAboutDropdown, showAboutDropdown)
            }
        ...
        <li className='dropdown relative px-4' ref={servicesDropdownRef}>
          <button
            ...
            onKeyDown={(e) => handleKeyDown(e, setShowServices, showServices)}
